...
%global oname python-magnumclient
%global sname python_magnumclient
...
Source0:        https://tarballs.openstack.org/%{oname}/%{sname}-%{upstream_version}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/%{oname}/%{sname}-%{upstream_version}.tar.gz.asc
...
%changelog
* Thu Jul 21 2026 Luca Albrecht <luca@albright.one> - 4.11.0-1
- Update to upstream version 4.11.0
* Thu Jul 21 2026 Luca Albrecht <luca@albright.one> - 4.10.0-1
